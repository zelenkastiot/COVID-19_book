...
## SIR модел
Еден од најлесните начини да се моделира ваква болест (вирус) што доста често се користи во епидемолошки анализи е **compartmental** модел (компартмантскиот, ); ваквиот модел ја дели популацијата на неколку оддели, на пример: 
